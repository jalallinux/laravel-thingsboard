...
class Configuration
{
    ...
    {
        return [
            'alarmsTtlDays' => $this->getAlarmsTtlDays(),
            'cassandraQueryTenantRateLimitsConfiguration' => (string) $this->getCassandraQueryTenantRateLimitsConfiguration(),
            'customerServerRestLimitsConfiguration' => (string) $this->getCustomerServerRestLimitsConfiguration(),
            'defaultStorageTtlDays' => $this->getDefaultStorageTtlDays(),
            'maxAssets' => $this->getMaxAssets(),
            'maxCreatedAlarms' => $this->getMaxCreatedAlarms(),
            'maxCustomers' => $this->getMaxCustomers(),
            'maxDPStorageDays' => $this->getMaxDPStorageDays(),
            'maxDashboards' => $this->getMaxDashboards(),
            'maxDevices' => $this->getMaxDevices(),
            'maxEmails' => $this->getMaxEmails(),
            'maxJSExecutions' => $this->getMaxJSExecutions(),
            'maxOtaPackagesInBytes' => $this->getMaxOtaPackagesInBytes(),
            'maxREExecutions' => $this->getMaxREExecutions(),
            'maxResourcesInBytes' => $this->getMaxResourcesInBytes(),
            'maxRuleChains' => $this->getMaxRuleChains(),
            'maxRuleNodeExecutionsPerMessage' => $this->getMaxRuleNodeExecutionsPerMessage(),
            'maxSms' => $this->getMaxSms(),
            'maxTransportDataPoints' => $this->getMaxTransportDataPoints(),
            'maxTransportMessages' => $this->getMaxTransportMessages(),
            'maxUsers' => $this->getMaxUsers(),
            'maxWsSessionsPerCustomer' => $this->getMaxWsSessionsPerCustomer(),
            'maxWsSessionsPerPublicUser' => $this->getMaxWsSessionsPerPublicUser(),
            'maxWsSessionsPerRegularUser' => $this->getMaxWsSessionsPerRegularUser(),
            'maxWsSessionsPerTenant' => $this->getMaxWsSessionsPerTenant(),
            'maxWsSubscriptionsPerCustomer' => $this->getMaxWsSubscriptionsPerCustomer(),
            'maxWsSubscriptionsPerPublicUser' => $this->getMaxWsSubscriptionsPerPublicUser(),
            'maxWsSubscriptionsPerRegularUser' => $this->getMaxWsSubscriptionsPerRegularUser(),
            'maxWsSubscriptionsPerTenant' => $this->getMaxWsSubscriptionsPerTenant(),
            'rpcTtlDays' => $this->getRpcTtlDays(),
            'tenantEntityExportRateLimit' => (string) $this->getTenantEntityExportRateLimit(),
            'tenantEntityImportRateLimit' => (string) $this->getTenantEntityImportRateLimit(),
            'tenantNotificationRequestsPerRuleRateLimit' => (string) $this->getTenantNotificationRequestsPerRuleRateLimit(),
            'tenantNotificationRequestsRateLimit' => (string) $this->getTenantNotificationRequestsRateLimit(),
            'tenantServerRestLimitsConfiguration' => (string) $this->getTenantServerRestLimitsConfiguration(),
            'transportDeviceMsgRateLimit' => (string) $this->getTransportDeviceMsgRateLimit(),
            'transportDeviceTelemetryDataPointsRateLimit' => (string) $this->getTransportDeviceTelemetryDataPointsRateLimit(),
            'transportDeviceTelemetryMsgRateLimit' => (string) $this->getTransportDeviceTelemetryMsgRateLimit(),
            'transportTenantMsgRateLimit' => (string) $this->getTransportTenantMsgRateLimit(),
            'transportTenantTelemetryDataPointsRateLimit' => (string) $this->getTransportTenantTelemetryDataPointsRateLimit(),
            'transportTenantTelemetryMsgRateLimit' => (string) $this->getTransportTenantTelemetryMsgRateLimit(),
            'type' => $this->getType(),
            'warnThreshold' => $this->getwarnThreshold(),
            'wsMsgQueueLimitPerSession' => $this->getWsMsgQueueLimitPerSession(),
            'wsUpdatesPerSessionRateLimit' => (string) $this->getWsUpdatesPerSessionRateLimit(),
        ];
    }
