...
class GetBundleWidgetTypesInfosTest extends TestCase
{
    public function testStructure()
    {
        ...
        $widgetTypes = thingsboard($tenantUser)->widgetType()->getBundleWidgetTypesInfos($bundleAlias);
        ...
        collect($widgetTypes)->each(function ($widgetType) use ($bundleAlias) {
            ...
            $this->assertInstanceOf(Base64Image::class, $widgetType->image);
