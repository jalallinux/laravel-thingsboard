...
class CreateDefaultRuleChainTest extends TestCase
{
    public function testCreateDeviceSuccess()
    {
        ...
        $ruleChain = thingsboard($tenantUser)->ruleChain($attributes)->createDefaultRuleChain();
    ...
    public function testRequiredProperty()
    {
        ...
        thingsboard($user)->ruleChain(Arr::except($attributes, 'name'))->createDefaultRuleChain();
    }
}
