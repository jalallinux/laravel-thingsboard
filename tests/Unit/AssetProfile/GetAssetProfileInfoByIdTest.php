...
class GetAssetProfileInfoByIdTest extends TestCase
{
    ...
    public function testInvalidUuid()
    {
        ...
        thingsboard($user)->assetProfile()->getAssetProfileInfoById(substr_replace($this->faker->uuid, 'z', -1));
    }
    ...
    public function testNonExistUuid()
    {
        ...
        thingsboard($user)->assetProfile()->getAssetProfileInfoById($this->faker->uuid);
    }
}
