...
class GetCustomerEdgeInfosTest extends TestCase
{
    public function testStructure()
    {
        ...
        $edges = thingsboard($tenantUser)->edge()->getCustomerEdgeInfos(
    ...
    public function testPaginationData()
    {
        ...
        thingsboard($tenantUser)->edge()->assignEdgeToCustomer($customerId, $edgeId);
        $edges = thingsboard()->edge()->withUser($tenantUser)->getCustomerEdgeInfos($customerId, $pagination);
