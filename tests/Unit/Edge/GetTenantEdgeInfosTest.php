...
class GetTenantEdgeInfosTest extends TestCase
{
    public function testStructure()
    {
        $user = $this->thingsboardUser(EnumAuthority::TENANT_ADMIN());

        $edges = thingsboard($user)->edge()->getTenantEdgeInfos(PaginationArguments::make());
    ...
    public function testPaginationData()
    {
        ...
        $edges = thingsboard($user)->edge()->getTenantEdgeInfos($pagination);
